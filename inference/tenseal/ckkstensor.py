...
class CKKSTensor(AbstractTensor):
    ...
    def pool_(self, locations, kernels) -> "CKKSTensor":
        self.data.pool_(locations, kernels)
        return self
        
    def conv_fusion_(self, locations, kernels) -> "CKKSTensor":
        self.data.conv_fusion_(locations, kernels)
        return self
