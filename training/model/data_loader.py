...
def fetch_dataloader(types, params):
    ...
    devset = torchvision.datasets.MNIST(root='./mnist', train=False, download=True, transform=transform)
    ...
    devloader = torch.utils.data.DataLoader(devset, batch_size=params.batch_size, num_workers=params.num_workers, pin_memory=params.cuda)
    '''
